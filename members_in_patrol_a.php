...
<form style="padding-top:30px;">
		<label for="password" style="padding-left:220px;">Signed On Patrol To Patrol A</label>
...
<div class="together">
<input id="signout" onclick="location.href='delete_a.php'" type="button" name="submit" value="Sign Out Member" />
<input id="signout" onclick="location.href='signonA.php'" type="button" name="submit" value="Sign Member On" />
