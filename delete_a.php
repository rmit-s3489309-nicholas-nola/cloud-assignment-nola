...
$sql = "DELETE FROM patrolA WHERE first_name = '$fname' AND last_name = '$lname'";
...
$sql = "UPDATE patrolA SET on_off = 'Off' WHERE first_name = '$fname' AND last_name = '$lname'";
...
<form id="login" action="delete_a.php" method="post" accept-charset="UTF-8">
